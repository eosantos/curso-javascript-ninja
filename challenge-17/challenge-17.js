...
(function () {
  ...
  // ?
  console.log(text.replace(/Manuel Marques de Sousa/, "Eduardo Oliveira"));
  ...
  // ?
  console.log(
    text.replace(/O Centauro de Luvas/g, function (phrese) {
      return phrese.toUpperCase();
    })
  );
  /*
  ...
  // ?
  var regexDate = /(\d\d) de (\w\w\w\w\w) de (\d\d\d\d)/;
